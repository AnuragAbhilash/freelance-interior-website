  ...
  const services = [
    {
      ...
      description: "Seamless incorporation of interior design into your construction plans",
      image: "/BP.jpeg",
      features: ["Space Planning", "Material Selection", "Finishes Coordination", "Custom Solutions"]
    },
    {
      title: "Model Unit Staging",
      description: "Show-stopping model units that drive sales and set quality standards",
      image: "/BP1.avif",
      features: ["Furniture Packages", "Decor Schemes", "Lifestyle Branding", "Photography Prep"]
    },
    {
      title: "Bulk Procurement",
      description: "Cost-effective sourcing of materials and finishes for multiple units",
      image: "/BP2.avif",
      features: ["Vendor Management", "Quality Control", "Logistics Coordination", "Cost Savings"]
    },
    {
      title: "Turnkey Solutions",
      description: "Complete interior packages ready for immediate occupancy",
      image: "/BP3.avif",
      features: ["Fully Furnished", "Decorated", "Utilities Connected", "Move-in Ready"]
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Understanding your project scope, timeline, and target market"
    },
    {
      icon: "ri-blueprint-line",
      title: "Design Development",
      description: "Creating cohesive interior schemes aligned with architectural plans"
    },
    {
      icon: "ri-team-line",
      title: "Coordination",
      description: "Synchronizing with construction teams for seamless execution"
    },
    {
      icon: "ri-home-5-line",
      title: "Delivery",
      description: "Final installation and quality assurance for handover"
    }
  ];
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: `url('/BP BG.avif')`
          }}
        />
        ...
        <div className="relative z-10 text-center text-white max-w-4xl px-8">
          ...
          <p className="text-3xl font-great-vibes mb-8 animate-fadeInUp opacity-90">
            Elevating developments through design collaboration
          </p>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-stone-600 max-w-3xl mx-auto text-xl leading-relaxed font-light">
              We partner with builders and developers to create interior spaces that enhance property value and accelerate sales.
            </p>
          </div>
      ...
      <section className="py-32 bg-gradient-to-br from-stone-100 to-stone-200">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-stone-600 max-w-3xl mx-auto text-xl leading-relaxed font-light">
              We align our design process with your construction timeline for seamless integration.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12 mt-16">
            <div className="group">
              ...
              <h3 className="text-xl font-playfair text-stone-800 mb-4">Faster Sales</h3>
              <p className="text-stone-600">Staged units that help buyers visualize living in the space</p>
            </div>
            ...
            <div className="group">
              ...
              <h3 className="text-xl font-playfair text-stone-800 mb-4">Higher Margins</h3>
              <p className="text-stone-600">Premium finishes that command better prices per square foot</p>
            </div>
            ...
            <div className="group">
              ...
              <p className="text-stone-600">Single-point responsibility for all interior elements</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-stone-800 text-white">
        <div className="max-w-4xl mx-auto px-8 text-center">
          ...
          <p className="text-xl font-light mb-12 opacity-90">
            Let's discuss how our partnership can add value to your next project
          </p>
          <Link 
            href="/contact"
          ...
          >
            <span className="relative z-10">Request Builder Consultation</span>
