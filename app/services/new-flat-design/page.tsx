...
export default function NewFlatDesign() {
  ...
  const services = [
    {
      ...
      description: "Optimized layouts that maximize every square foot of your new flat",
      image: "/NFD.jpeg",
      features: ["Furniture Layout", "Traffic Flow", "Functional Zones", "Storage Solutions"]
    },
    {
      title: "Material Selection",
      description: "Guidance in choosing finishes that match your style and budget",
      image: "/NFD3.png",
      features: ["Flooring Options", "Wall Treatments", "Countertops", "Fixture Selection"]
    },
    {
      title: "Color Consultation",
      description: "Professional color schemes that create the perfect atmosphere",
      image: "/NFD2.webp",
      features: ["Color Psychology", "Lighting Effects", "Mood Creation", "Coordination"]
    },
    {
      title: "Furniture Planning",
      description: "Smart furniture solutions tailored to your space and needs",
      image: "/NFD3.webp",
      features: ["Space-Saving Ideas", "Ergonomic Design", "Style Matching", "Budget Options"]
    }
  ];
  ...
  const process = [
    {
      ...
      description: "We'll discuss your vision, needs and budget for your new flat"
    },
    {
      icon: "ri-ruler-line",
      title: "Space Analysis",
      description: "Detailed measurement and assessment of your new space"
    },
    {
      icon: "ri-palette-line",
      title: "Design Proposal",
      description: "Presentation of layout options and material selections"
    },
    {
      icon: "ri-tools-line",
      title: "Implementation",
      description: "Guidance through the execution phase with trusted vendors"
    }
  ];
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: `url('/NFD BG.jpg')`
          }}
        />
        ...
        <div className="relative z-10 text-center text-white max-w-4xl px-8">
          ...
          <p className="text-3xl font-great-vibes mb-8 animate-fadeInUp opacity-90">
            Bespoke interiors for your brand new home
          </p>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-stone-600 max-w-3xl mx-auto text-xl leading-relaxed font-light">
              We provide comprehensive interior design services tailored specifically for new flats, ensuring every detail reflects your personal style.
            </p>
          </div>
      ...
      <section className="py-32 bg-gradient-to-br from-stone-100 to-stone-200">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-stone-600 max-w-3xl mx-auto text-xl leading-relaxed font-light">
              Our straightforward process ensures your new flat design journey is smooth and stress-free.
            </p>
          </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-8 text-center">
          <h2 className="text-5xl font-playfair text-stone-800 mb-12">
            Why Choose Our New Flat Design Service?
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-12 mt-16">
            <div className="group">
              ...
              <h3 className="text-xl font-playfair text-stone-800 mb-4">Personalized Approach</h3>
              <p className="text-stone-600">Every design is customized to your unique preferences and lifestyle</p>
            </div>
            ...
            <div className="group">
              ...
              <h3 className="text-xl font-playfair text-stone-800 mb-4">Budget-Conscious</h3>
              <p className="text-stone-600">Quality designs that respect your financial parameters</p>
            </div>
            ...
            <div className="group">
              ...
              <h3 className="text-xl font-playfair text-stone-800 mb-4">Efficient Process</h3>
              <p className="text-stone-600">Streamlined workflow to deliver results without unnecessary delays</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-stone-800 text-white">
        <div className="max-w-4xl mx-auto px-8 text-center">
          <h2 className="text-5xl font-playfair mb-8">
            Ready to Design Your New Flat?
          </h2>
          <p className="text-xl font-light mb-12 opacity-90">
            Let's create a space that feels like home from day one
          </p>
          <Link 
            href="/contact"
